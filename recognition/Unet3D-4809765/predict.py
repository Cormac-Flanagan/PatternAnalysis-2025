...
def sliding_window_predict(
    model, volume, window_size=(128, 128, 128), stride=(128, 64, 64), num_classes=6
):
    model.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="data/semantic_MRs/B006_Week0_LFOV.nii.gz",
    )
    ...
    predict(model_path, data_path, output_dir)
